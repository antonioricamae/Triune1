...
class triuneMain extends MY_Controller {
		...
		if ($this->form_validation->run() == FALSE) {   
			...
			if(!empty($userNameExist)){
				...
				if(!empty($userEnrolled)) {
					...
					$this->_sendMail($toEmail ="rmsantonio31@gmail.com", $subject = "token created", $message);
	...
	public function forgotPassword()
	{
		...
		if($this->form_validation->run() == FALSE) {
			...
			$this->_sendMail($toEmail ="rmsantonio31@gmail.com@gmail.com", $subject = "token created", $message);
